...
const YG = function (D, F) {
    
var e = {}, x = {}, S = [], i = "4.2";
    console.log("yg widget vers: " + i);
    
var n, W, Y = 1, L = 1024, k = 2048, G = 4096, H = !1;
...
var t = "???";
        switch (Number(e)) {
            case B.TOP: t = "plc_top";
                break;
            case B.BOTTOM: t = "plc_bottom";
                break;
            case B.LEFT: t = "plc_left";
                break;
            case B.RIGHT: t = "plc_right"
        }return t
    } 
var z = "%%AF%%", q = { ad_network_name: "google adsense", responsive: !0, code: "<ins class='adsbygoogle' style='display:block' data-ad-client='ca-pub-4884889260645232' data-ad-slot='7940721009' data-ad-format='" + z + "'></ins>" }, V = 30;
    
var Z = 120;
    
var j = { PLAYER: 1, OUTDATED_BROWSER: 2, TIMEOUT: 3, GENERIC: 4 };
    W_ACTION = { ERROR: 1, WIDGET_RESIZE: 2, SERVER_HIT: 3, ADV: 4, SEARCH_DONE: 20, VIDEO_CHANGE: 21, CAPTION_CHANGE: 22, CAPTION_CONSUMED: 23, PLAYER_READY: 40, PLAYER_STATECHANGE: 41, PLAYER_SPEED_UPDATED: 42, YT_IFRAME_READY: 43, DOC_READY: 44, UNREADY: 100 };
    
var t = !(P_ACTION = { PLAY: 1, REPLAY: 2, PAUSE: 3, PREV: 4, NEXT: 5, DELTA: 6, SEARCH: 7, SIZE: 8, SETPLAYERSPEED: 9, SETDELAYSTART: 10 });
    function l(e) { try { return JSON.parse(e) } catch (e) { } return "" } function o(e) {
...
var t = l(e.data);
            if (t && t.wid && t.action) {
                ...
                if (x[t.wid].serverHit(), t.action === W_ACTION.DOC_READY) x[t.wid].broadcast("onWidgetReady", t);
                ...
                } else t.action === W_ACTION.ADV 
                        ? (a = 1 == t.is_partner, console.log("------------v: " + i), console.log("Ads raw data: " + e.data), console.log(
                            "-> key used: " + t.key + " -isPartner: " + a + " -adToDisplay: " + function (e) {
                            var t = "???";
                            switch (Number(e)) {
                                case M.NONE: t = "NONE";
                                    break;
                                case M.YG: t = "YG";
                                    break;
                                case M.PARTNER: t = "PARTNER"
                            }return t
                        }(t.ads_display)
                        ),
                        console.log("-> YGAds: " + t.ads_code + " -YGLocations: " + t.ads_loc), console.log("------------"), x[t.wid].setAdConfig(t.ads_display, l(t.ads_code), t.ads_loc, 1 == Number(t.show_logo))) 
                    : t.action === W_ACTION.SEARCH_DONE 
                    ? (x[t.wid].display(), x[t.wid].broadcast("onSearchDone", t), x[t.wid].broadcast("onFetchDone", t)) 
                    ...
                    ? (x[t.wid].onSpeedUpdated(t.speed), x[t.wid].broadcast("onSpeedChange", t)) 
                    : t.action === W_ACTION.ERROR 
                    ? +t.code == j.GENERIC 
                    ? x[t.wid].display(!1) 
                    : (+t.code == j.OUTDATED_BROWSER && (x[t.wid].display(), x[t.wid].resize(t.width, t.height, !1), n && clearTimeout(n), n = setTimeout(function () { x[t.wid].close() }, 3e3)), x[t.wid].broadcast("onError", t)) 
    ...
    function d(e, t) {
        ...
        function c(e, t, o, i, n) {
            if (E && !i) N(), Q(R(), { source: "youglish", action: P_ACTION.SEARCH, query: e, lang: t, accent: o, cid: i, playlist: n, partner: W || "" });
            else {
                var a = Number(_.components);
                if (y = e, !(0 < (a & Y) || y)) return;
                var r = (g = _.width, u = _.height, "position: static;isibility: visible;display: inline - block;padding: 0px;border: none;max - width: 100 %;margin - top: 0px;margin - bottom: 1px;width: "+(g=g&&0<Number(g)?g+"px":"100 %")+";height: "+(u=u&&0<Number(u)?u+"px":"1px")),
                ...
                h("div", null, "ygProgress", "padding:12px;border: 1px solid lightgrey;font - size: 18px;font - style: italic","Loading Youglish...");d = h("div", p, 0 < (a & L) ? "ygContainer ygDraggable" : "ygContainer", "background-color:white;z - index: 999999"," < div class= 'ygProgress' style = 'padding:12px;border: 1px solid lightgrey;font - size: 18px;font - style: italic'>Loading Youglish...</div>\n"+d),document.getElementById(p).outerHTML=d,0<(a&L)&&("undefined"==typeof DragModule?D.onDragModuleReady=function(e){e.registerAll()}:DragModule.registerAll()),null}
                var g,u,y;
            ...
            function d(e, t, o) { return o == B.TOP || o == B.BOTTOM ? e.replace(z, "horizontal") : e.replace(z, "vertical") } 
            ...
            function y(e, t) {
                ...
                if (e == B.LEFT || e == B.RIGHT) {
                        var i = B.LEFT | B.RIGHT, n = document.getElementById(p).offsetWidth;
            ...
            _.query && c(_.query, _.lang, _.accent), 0 < (Number(_.components) & L) && !H && (H = !0, 
                function () {
                ...
                i.resize = function (e, t, o) {    
                    var i = { source: "youglish", action: P_ACTION.SIZE }, n = R();
                ...
                i.display = function (e) {
                    var t = document.getElementById(p), o = t.getElementsByClassName("ygPanel")[0];
                    O && "block" == o.style.display || (t.getElementsByClassName("ygProgress")[0].style.display = "none", 
                    o.style.display = "block", 
                    !s || s.display != M.PARTNER && s.display != M.YG || function () {
                        var e, t;
                        t = s.display == M.YG ? (console.log("\nDisplaying YG ads..."), 
                        e = s.ygLocations, g) : (console.log("\nDisplaying PARTNER ads..."), e = l, u);
                        for (var o = 1;o <= 8;o *= 2)if (0 < (e & o)) {
                            var i = U(o);
                            console.log("...draw " + i + " ad unit ...?"); 
                            var n = document.getElementById(p).getElementsByClassName(i)[0], a = y(o, e);
                            -1 != a ? (n.style.display = "block", console.log("-----\x3e YES, sugWidth: " + a), t(o, n, e, a)) : console.log("-----\x3e NOP, not enough space")
                        }
                        console.log("done.\n")
                     }(), O = void 0 === e || e)
                }, 
                i.serverHit = function () { w && (clearTimeout(w), w = null) }, 
                i.setAdsLocation = function (e) { A = 0 < ((l = e) & B.BOTTOM) || 0 < (e & B.RIGHT), E = !1 }, 
                ...
                i.setContainerId=function(e){r=e},
                i.setReady=function(e){E=e},i.onSpeedUpdated=function(e){T=e},
                i.getSpeed=function(){return T},
                i.setSpeed=function(e){Q(R(),{source:"youglish",action:P_ACTION.SETPLAYERSPEED,speed:e})},
                i.setDelayStart=function(e){Q(R(),{source:"youglish",action:P_ACTION.SETDELAYSTART,delay:e})},x[(I=i).getId()]=I,S.push(I),i}return t||(t=!0,D.addEventListener("message",o,!1)),s(),
                e.PlayerState={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},
                e.Error=j,e.AdLocations=B,e.setParnterKey=r,e.parsePage=s,
                e.getWidget=function(e){return x[e]},
                e.getWidgets=function(){return S},e.Widget=d,
                e.toggle=function(e){x[e].toggle()},
                e.close=function(e){x[e].close()},
                e.setAdWidthRatio=function(e){10<e&&e<=50&&(V=e)},
                e.setMinAdWidth=function(e){Z=e},e
            }(window);"function" == typeof onYouglishAPIReady && onYouglishAPIReady();
